			...
			public void actionPerformed(ActionEvent arg0) {
				if(insulinUnits > insulin.getAvailable()){
					...
					if (!textInsulin.getText().equals("")) {
						if(Integer.parseInt(textInsulin.getText())>15){
							JOptionPane.showMessageDialog(BolusGUI.this, "U can not inject more than 15unit", "Error amount",JOptionPane.ERROR_MESSAGE);
